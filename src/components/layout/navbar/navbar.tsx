...
import { Logo } from '@/src/components/ui/branding';
      ...
      <div className="h-full font-medium mr-2">
        {user ? (
          <div className="w-[298px] flex items-center justify-center text-center space-x-5">
            {/* <Button type="primary" /> */}
            <Link href="dashboard">
              <div className="h-[4rem] rounded-[5px] text-black font-bold flex items-center justify-center text-center text-[1.4rem] rounded-[8px]">
                Dashboard
              </div>
            </Link>
            {/* <UserButton /> */}
